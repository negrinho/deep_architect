...
# NOTE: this is going to do this, for example, I can get the state example
# from the model.

# NOTE: this is going to be important.
# I think that it is important to not allow deletions or overlapping stuff

# the values for the components
# but remember that the components are

# most likely, it won't be a problem if the model needs to load it from disk.
# we can check if it exists then.