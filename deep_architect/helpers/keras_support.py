...
fns = [
    kl.Add, kl.Subtract, kl.Multiply, kl.Average, kl.Maximum, kl.Minimum,
    kl.Concatenate, kl.Dot, kl.Dense, kl.Activation, kl.Dropout, kl.Flatten,
    kl.Reshape, kl.Permute, kl.RepeatVector, kl.Lambda,
    kl.ActivityRegularization, kl.Masking, kl.SpatialDropout1D,
    kl.SpatialDropout2D, kl.SpatialDropout3D, kl.Conv1D, kl.Conv2D,
    kl.SeparableConv1D, kl.SeparableConv2D, kl.DepthwiseConv2D,
    ...
    kl.CuDNNLSTM, kl.BatchNormalization, kl.Embedding, kl.GaussianNoise,
    kl.GaussianDropout, kl.AlphaDropout, kl.LeakyReLU, kl.PReLU, kl.ELU,
    kl.ThresholdedReLU, kl.Softmax, kl.ReLU, kl.Bidirectional,
