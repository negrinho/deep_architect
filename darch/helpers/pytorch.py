...
class PyTModule(co.Module):
    ...
    :mod:`darch.search_spaces.pytorch.conv2d`.
...
class PyTNetContainer(nn.Module):
    """Encapsulates a network of modules of type :class:`darch.helpers.pytorch.PyTModule`
    ...
    Args:
        inputs (dict[str,darch.core.Input]): Dictionary of names to inputs.
        outputs (dict[str,darch.core.Output]): Dictionary of names to outputs.
    """
